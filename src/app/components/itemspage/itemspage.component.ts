...
//     // Automatically sync purchaseRate with rate if not set
...
//     // Optional: Save to backend (currently only pushing locally)
//     this.items.push(finalItem);
//     this.updateFilteredItems();
//     this.closeModal();

//     // If saving to backend is required:
...
//       const originalItems = [...this.items]; // Backup for rollback in case of error
...
//         next: () => {
//           // Successfully deleted on server, no need to do anything as local state is already updated
//           this.updateFilteredItems(); // Ensure UI is in sync
//         },
//         error: (error) => {
//           console.error('Error deleting item:', error);
//           // Rollback local changes if server deletion fails
